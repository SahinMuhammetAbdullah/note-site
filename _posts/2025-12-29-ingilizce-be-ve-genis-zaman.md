---
title: İngilizce Bölüm 1 | "Be" Fiili ve Geniş Zaman
...
# prev_note:
# prev_note_link:
next_note: İngilizce Bölüm 2 | Şimdiki Zaman
next_note_link: /language/english/ingilizce-simdiki-zaman/
related_posts:
...
![İşaret Sıfatları](/assets/images/postimages/isaret-sıfatları.png)
...
```mermaid
graph TD
    A[Year<br/>in 2025] --> B[Month<br/>in November]
    B --> C[Day<br/>on Monday]
    C --> D[Specific Time<br/>at 4:30 p.m.]
    D --> E[Exact Moment<br/>at midnight]
